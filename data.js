...
/**
 * Saved presets. A preset is just a config blob under a name, owned by
 * the Roblox player the linked script reports. One per owner may be
 * marked autoload, which the script applies at startup.
 */
const Presets = {
  async list(owner) {
    const { data, error } = await sb
